...
namespace CarPartsPatron.Auth
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(Credentials credentials)
        {
            ...
            if (userProfile == null) //handles error if null
            {
        ...
        {
            //check password and confirm same password to register
            if (!ModelState.IsValid)
            {
            ...
            var newUserProfile = new UserProfile //new instance of user
            {
                Email = fbUser.Email,
            ...
            _userProfileRepository.Add(newUserProfile); //sends new user to database
